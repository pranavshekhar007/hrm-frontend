                ...
                <table className="table">
                  <tbody>
                    <tr style={{ background: "#F3F3F3", color: "#000" }}>
                      ...
                      <th className="text-center py-3">Slug</th>
                ...
                >
                  <div className="w-100 px-2">
                    ...
                    <button
                      ...
                      onClick={
                        addFormData?.name && addFormData?.slug && addFormData?.description && addFormData?.status && !isLoading
              ...
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    ...
                    {editFormData?.name && editFormData?.slug && editFormData?.description && editFormData?.status ? (
                      <button
                        className="btn btn-success w-100 mt-4"
